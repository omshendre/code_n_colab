...
function Stats({ setInput }) {
  ...
  return (
    <div className='flex flex-col justify-center items-center pt-[20px] gap-2'>
      ...
      <textarea
      className='h-[20vh] w-[80%] p-3 pl-4 rounded-lg border font-sans text-blue-300 overflow-auto'
      ...
      style={{ backgroundColor: '#1C1E29', resize: 'none' }} // Apply background color style and disable resizing
    />
    </div>
  );
}
